        ...
        "TrustIndicators.useEffect": ()=>{
            ...
            const fetchStats = {
                "TrustIndicators.useEffect.fetchStats": async ()=>{
                    try {
                        const response = await fetch("".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL, "/campaigns/stats"));
                        if (response.ok) {
...
//# sourceMappingURL=src_fc896138._.js.map
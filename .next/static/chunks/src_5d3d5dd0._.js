...
"[project]/src/components/admin/FundraisedDataTable.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FundraisedDataTable() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FundraisedDataTable.useEffect": ()=>{
            const fetchCompleted = {
                "FundraisedDataTable.useEffect.fetchCompleted": async ()=>{
                    try {
                        // Fetch campaigns - backend limit is max 100
                        // We'll fetch first page with max limit to get most campaigns
                        // For completed campaigns, 100 should be enough for most cases
            ...
            }["FundraisedDataTable.useEffect.fetchCompleted"];
            fetchCompleted();
        }
    }["FundraisedDataTable.useEffect"], [
        getAllCampaigns
        ...
        "FundraisedDataTable.useEffect": ()=>{
            if (campaigns.length > 0) {
                ...
                const completed = campaigns.filter({
                    "FundraisedDataTable.useEffect.completed": (c)=>c.status === 'completed' || c.currentAmount >= c.goalAmount && c.goalAmount > 0
                }["FundraisedDataTable.useEffect.completed"]);
                console.log("Completed campaigns found:", completed.length);
            }
        }
    }["FundraisedDataTable.useEffect"], [
        campaigns
    ...
    const completedCampaigns = campaigns.filter((campaign)=>{
        var _campaign_timeline;
        // A campaign is completed if:
        // 1. status is 'completed', OR
        // 2. currentAmount >= goalAmount (goal reached), OR
        // 3. End date has passed
        const now = new Date();
        const endDate = ((_campaign_timeline = campaign.timeline) === null || _campaign_timeline === void 0 ? void 0 : _campaign_timeline.endDate) ? new Date(campaign.timeline.endDate) : null;
        const goalReached = campaign.goalAmount > 0 && campaign.currentAmount >= campaign.goalAmount;
        const isExpired = endDate && endDate < now;
        const isCompleted = campaign.status === 'completed' || goalReached || isExpired && campaign.status === 'active';
        return isCompleted;
    });
    console.log("=== Fundraised Data Debug ===");
    ...
    console.log("Sample campaigns:", campaigns.slice(0, 3).map((c)=>({
            title: c.title,
            status: c.status,
            currentAmount: c.currentAmount,
            goalAmount: c.goalAmount,
            goalReached: c.goalAmount > 0 && c.currentAmount >= c.goalAmount
        })));
    const filteredFundraised = completedCampaigns.filter((item)=>{
        var _item_title, _item_fundraiser_name, _item_fundraiser;
        return ((_item_title = item.title) === null || _item_title === void 0 ? void 0 : _item_title.toLowerCase().includes(searchTerm.toLowerCase())) || ((_item_fundraiser = item.fundraiser) === null || _item_fundraiser === void 0 ? void 0 : (_item_fundraiser_name = _item_fundraiser.name) === null || _item_fundraiser_name === void 0 ? void 0 : _item_fundraiser_name.toLowerCase().includes(searchTerm.toLowerCase()));
    });
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: "Completed FundRaised Data"
                    }, void 0, false, {
                        fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                        lineNumber: 83,
                        columnNumber: 9
                    }, this),
                    ...
                    isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Loading completed campaigns..."
                            }, void 0, false, {
                                fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                lineNumber: 140,
                                columnNumber: 13
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        children: currentEntries.length > 0 ? currentEntries.map((campaign, index)=>{
                                            var _campaign_goalAmount, _campaign_currentAmount, _campaign_timeline, _campaign_timeline1, _campaign_fundraiser, _campaign_fundraiser1, _campaign_beneficiary_contact, _campaign_beneficiary, _campaign_fundraiser2;
                                            const percentage = campaign.goalAmount > 0 ? (campaign.currentAmount / campaign.goalAmount * 100).toFixed(1) : '100';
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "border-b hover:bg-gray-50 transition-colors ".concat(index % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'),
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: ((_campaign_timeline = campaign.timeline) === null || _campaign_timeline === void 0 ? void 0 : _campaign_timeline.startDate) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: new Date(campaign.timeline.startDate).toLocaleDateString()
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                                                    lineNumber: 189,
                                                                    columnNumber: 33
                                                                }, this),
                                                                ((_campaign_timeline1 = campaign.timeline) === null || _campaign_timeline1 === void 0 ? void 0 : _campaign_timeline1.endDate) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-xs text-gray-500",
                                                                    children: [
                                                                        "to ",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-4 py-4",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-700 flex items-center gap-1 w-fit",
                                                            children: [
                                                    ...
                                                    isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: "No completed fundraisers yet"
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                                                lineNumber: 224,
                                                                columnNumber: 29
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "text-sm text-gray-400 mt-4 max-w-md mx-auto space-y-2",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: "font-semibold text-gray-600 mb-3",
                                                                        children: "A campaign appears here when:"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                                                        lineNumber: 226,
                                                                        columnNumber: 31
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                                children: "Goal amount is reached (Raised Amount ≥ Goal Amount)"
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                                                                lineNumber: 229,
                                                                                columnNumber: 33
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                                children: "End date has passed and campaign was active"
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                                                                lineNumber: 230,
                                                                                columnNumber: 33
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                " Currently, all campaigns are either ",
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                    className: "font-mono",
                                                                                    children: "'pending'"
                                                                                }, void 0, false, {
                                                                                ...
                                                                                " (running). Once a campaign reaches its goal or expires, it will automatically appear here."
                                                                            ]
                                                                        }, void 0, true, {
                                                                            fileName: "[project]/src/components/admin/FundraisedDataTable.jsx",
                                                                            lineNumber: 233,
...
_s(FundraisedDataTable, "lxrZwZDEeb3L8LLqCWNe8ZncsXk=", false, function() {
    return [
...
_c = FundraisedDataTable;
var _c;
__turbopack_context__.k.register(_c, "FundraisedDataTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/admin/fundraised/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$FundraisedDataTable$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/FundraisedDataTable.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function FundraisedDataPage() {
    ...
    if (isLoading || !canRender) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/app/admin/fundraised/page.jsx",
                lineNumber: 12,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$AdminLayout$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$FundraisedDataTable$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/src/app/admin/fundraised/page.jsx",
            lineNumber: 19,
            columnNumber: 7
        }, this)
...
_s(FundraisedDataPage, "ZWEOMdC4TlaB5ff5KIb3Crtt+xg=", false, function() {
    return [
...
_c = FundraisedDataPage;
var _c;
__turbopack_context__.k.register(_c, "FundraisedDataPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_5d3d5dd0._.js.map
...
"[project]/src/app/redeem-coupon/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RedeemCouponPage() {
    ...
    const { user, isAuthenticated, isLoading: authLoading, initializeAuth, getCurrentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RedeemCouponPage.useEffect": ()=>{
            console.log("🔍 PATHNAME MONITOR: Current pathname:", pathname);
            if (pathname !== '/redeem-coupon' && !pathname.startsWith('/redeem-coupon')) {
                console.error("🚨 UNEXPECTED PATHNAME CHANGE! Current:", pathname, "Expected: /redeem-coupon");
                // If we're authenticated and somehow navigated away, redirect back
                if (isAuthenticated && pathname !== '/login') {
                    console.log("🔄 Redirecting back to /redeem-coupon");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RedeemCouponPage.useEffect": ()=>{
            ...
            const checkAuth = {
                "RedeemCouponPage.useEffect.checkAuth": async ()=>{
            ...
            }["RedeemCouponPage.useEffect.checkAuth"];
            checkAuth();
        }
    }["RedeemCouponPage.useEffect"], [
        initializeAuth,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RedeemCouponPage.useEffect": ()=>{
            ...
            console.log("isAuthenticated:", isAuthenticated);
            console.log("user:", !!user);
            console.log("Current window.location.pathname:", ("TURBOPACK compile-time truthy", 1) ? window.location.pathname : "TURBOPACK unreachable");
            // Check if token exists in cookies - if token exists, wait for auth to load
            const token = ("TURBOPACK compile-time truthy", 1) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('token') : "TURBOPACK unreachable";
            console.log("Token exists:", !!token);
            // If token exists, DON'T redirect - wait for auth to initialize
            if (token) {
                console.log("✅ Token found, waiting for auth to initialize - NO REDIRECT");
            ...
            if (isAuthenticated || user) {
                console.log("✅ User authenticated, staying on /redeem-coupon page - NO REDIRECT");
                // Explicitly check we're on the right page
                if ("object" !== 'undefined' && window.location.pathname !== '/redeem-coupon') {
                    console.log("⚠️ WARNING: Pathname mismatch! Current:", window.location.pathname, "Expected: /redeem-coupon");
                }
            }
        }
    }["RedeemCouponPage.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RedeemCouponPage.useEffect": ()=>{
            const loadCoupons = {
                "RedeemCouponPage.useEffect.loadCoupons": async ()=>{
            ...
            }["RedeemCouponPage.useEffect.loadCoupons"];
            if (isAuthenticated && user) {
                loadCoupons();
            }
        }
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$bi$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BiChevronUp"], {
                                                ...
                                                isUsedCoupons && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                    className: "px-4 py-3 text-left text-sm font-semibold text-gray-700",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-1",
                                                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        children: isLoadingCoupons ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            lineNumber: 324,
                                            columnNumber: 19
                                        }, this) : currentCoupons.length > 0 ? currentCoupons.map((coupon, index)=>{
                                            var _coupon_value, _coupon_value1;
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "border-b border-gray-100 ".concat(index % 2 === 0 ? 'bg-white' : 'bg-gray-50'),
                                                children: [
                                                    ...
                                                    isUsedCoupons && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-4 py-3 text-sm text-gray-700",
...
_s(RedeemCouponPage, "b/bsZlQ6Tj6L/QmrYYO16UZeTtg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
...
_c = RedeemCouponPage;
var _c;
__turbopack_context__.k.register(_c, "RedeemCouponPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_b5bcdded._.js.map
...
const uploadService = {
    // Upload single image
    uploadSingle: async function(file) {
        let folder = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : '';
        try {
            ...
            return ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : (_response_data_data = _response_data.data) === null || _response_data_data === void 0 ? void 0 : _response_data_data.url) || ((_response_data1 = response.data) === null || _response_data1 === void 0 ? void 0 : _response_data1.url);
        } catch (error) {
            var _error_response;
...
"[project]/src/components/admin/UploadFundraiserForm.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function UploadFundraiserForm() {
    ...
    const uploadImage = async (file)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$uploadService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadService"].uploadSingle(formData);
    ...
    const handleSubmit = async (e)=>{
        ...
        if (formData.heading.length < 10) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fundraiser heading must be at least 10 characters');
            return;
        }
        if (formData.heading.length > 100) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fundraiser heading cannot exceed 100 characters');
            return;
        }
        // Short description validation (20-200 characters)
        if (formData.summary.length < 20) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fundraiser summary must be at least 20 characters');
            return;
        }
        if (formData.summary.length > 200) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fundraiser summary cannot exceed 200 characters');
            return;
        }
        // Description validation (50-5000 characters)
        if (formData.description.length < 50) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fundraiser description must be at least 50 characters');
            return;
        }
        if (formData.description.length > 5000) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fundraiser description cannot exceed 5000 characters');
            return;
        }
        // Goal amount validation
        if (formData.targetAmount < 100) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Target amount must be at least ₹100');
            return;
        }
        if (!formData.mainPicture) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please upload main picture');
            return;
        }
        if (!formData.contact) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please provide contact number');
            return;
        }
        // Validate contact number (10 digits)
        const phoneRegex = /^[6-9]\d{9}$/;
        if (!phoneRegex.test(formData.contact.replace(/\D/g, ''))) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please provide a valid 10-digit contact number starting with 6-9');
            return;
        }
        if (!formData.startDate) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Please select campaign start date');
            return;
        }
        ...
        try {
            ...
            // Upload main picture
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].loading('Uploading images...');
            ...
            const finalBeneficiaryName = beneficiaryName.length >= 2 ? beneficiaryName : formData.heading.trim().substring(0, Math.min(50, formData.heading.length)) || 'Campaign Beneficiary';
            // Calculate end date properly (3 months from start date)
            const startDateObj = new Date(formData.startDate);
            const endDateObj = new Date(startDateObj);
            endDateObj.setMonth(endDateObj.getMonth() + 3);
            // Get backend base URL
            const backendBaseURL = ((_process_env_NEXT_PUBLIC_API_URL = ("TURBOPACK compile-time value", "http://localhost:5000/api")) === null || _process_env_NEXT_PUBLIC_API_URL === void 0 ? void 0 : _process_env_NEXT_PUBLIC_API_URL.replace('/api', '')) || 'http://localhost:5000';
            ...
            const campaignData = {
                ...
                images: [
                    {
                        url: "".concat(backendBaseURL).concat(mainImageUrl),
                        caption: 'Main Campaign Image',
                        isPrimary: true
                    },
                    ...additionalImages.map((img)=>({
                            ...img,
                            url: "".concat(backendBaseURL).concat(img.url),
                            isPrimary: false
                        }))
                ],
                ...
                beneficiary: {
                    ...
                    contact: {
                        ...
                        email: (user === null || user === void 0 ? void 0 : user.email) || '' // Use logged in user's email
                    }
                },
                location: {
                    city: 'Mumbai',
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].loading('Creating campaign...');
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].dismiss();
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Campaign created successfully and is now LIVE! 🎉');
            // Reset form
            handleReset();
            ...
            var _error_response, _error_response_data, _error_response1, _error_response_data1, _error_response2, _error_response_data2, _error_response3;
            ...
            console.error('Validation errors:', (_error_response1 = error.response) === null || _error_response1 === void 0 ? void 0 : (_error_response_data = _error_response1.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.errors);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].dismiss();
            // Show specific validation errors
            if (((_error_response2 = error.response) === null || _error_response2 === void 0 ? void 0 : (_error_response_data1 = _error_response2.data) === null || _error_response_data1 === void 0 ? void 0 : _error_response_data1.errors) && Array.isArray(error.response.data.errors)) {
                const errorMessages = error.response.data.errors.map((err)=>"".concat(err.field, ": ").concat(err.message)).join('\n');
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Validation failed:\n".concat(errorMessages), {
                    duration: 8000
                });
            } else if ((_error_response3 = error.response) === null || _error_response3 === void 0 ? void 0 : (_error_response_data2 = _error_response3.data) === null || _error_response_data2 === void 0 ? void 0 : _error_response_data2.message) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to create campaign. Please check all fields and try again.', {
                    duration: 5000
                });
            }
        } finally{
    ...
    const handleReset = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Form reset');
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                    ...
                    children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: [
                                            ...
                                            " / 200 characters ",
                                            formData.summary.length < 20 && "(".concat(20 - formData.summary.length, " more needed)")
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/admin/UploadFundraiserForm.jsx",
                                        lineNumber: 327,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                children: [
                                                    ...
                                                    " / 100 characters ",
                                                    formData.heading.length < 10 && "(".concat(10 - formData.heading.length, " more needed)")
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/components/admin/UploadFundraiserForm.jsx",
                                                lineNumber: 348,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: [
                                            ...
                                            " / 5000 characters ",
                                            formData.description.length < 50 && "(".concat(50 - formData.description.length, " more needed)")
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/admin/UploadFundraiserForm.jsx",
                                        lineNumber: 430,
                        ...
                        isSubmitting && uploadProgress > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "w-full",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(UploadFundraiserForm, "Bw70fZ+mgTdepgr106sSXNVaJvI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
_c = UploadFundraiserForm;
var _c;
__turbopack_context__.k.register(_c, "UploadFundraiserForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/admin/create-fundraiser/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$UploadFundraiserForm$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/UploadFundraiserForm.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function CreateFundraiserPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$AdminLayout$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$UploadFundraiserForm$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/src/app/admin/create-fundraiser/page.jsx",
            lineNumber: 19,
            columnNumber: 7
        }, this)
...
_s(CreateFundraiserPage, "ZWEOMdC4TlaB5ff5KIb3Crtt+xg=", false, function() {
    return [
...
//# sourceMappingURL=src_8c9d0766._.js.map
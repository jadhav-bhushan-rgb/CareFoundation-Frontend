    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const campaignData = {
                ...
                images: [
                    {
                        url: "http://localhost:5000".concat(mainImageUrl),
                        caption: 'Main Campaign Image',
                        isPrimary: true
                    },
                    ...additionalImages.map((img)=>({
                            ...img,
                            url: "http://localhost:5000".concat(img.url)
                        }))
                ],
                videos: videos,
                timeline: {
            ...
            console.error('Validation errors:', (_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.errors); // Show detailed errors
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].dismiss();
            // Show specific validation errors
            if (((_error_response1 = error.response) === null || _error_response1 === void 0 ? void 0 : (_error_response_data1 = _error_response1.data) === null || _error_response_data1 === void 0 ? void 0 : _error_response_data1.errors) && Array.isArray(error.response.data.errors)) {
                ...
                var _error_response_data2, _error_response2;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(((_error_response2 = error.response) === null || _error_response2 === void 0 ? void 0 : (_error_response_data2 = _error_response2.data) === null || _error_response_data2 === void 0 ? void 0 : _error_response_data2.message) || error.message || 'Failed to create campaign');
            }
        } finally{
...
function CreateFundraiserPage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, isAuthenticated, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
...
_s(CreateFundraiserPage, "xnavRt9/8I69TjgDkXMvx25pRI4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
...
//# sourceMappingURL=src_ae12ee9d._.js.map
...
"[project]/src/components/admin/FundraiserLiveTable.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function FundraiserLiveTable() {
    _s();
    const { campaigns, isLoading, getAllCampaigns } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$adminStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FundraiserLiveTable.useEffect": ()=>{
            const fetchFundraisers = {
                "FundraiserLiveTable.useEffect.fetchFundraisers": async ()=>{
                    try {
                        // Fetch both 'active' and 'approved' campaigns
                        // According to requirements: Campaign review and approval system
                        // After approval, campaigns should be active/live
                        await getAllCampaigns({
                            limit: 100
                        });
                        console.log("Fetched all campaigns for live view");
                        console.log("Campaigns in store:", campaigns.length);
                    } catch (error) {
                        console.error("Failed to load campaigns:", error);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Failed to load fundraisers");
                    }
                }
            }["FundraiserLiveTable.useEffect.fetchFundraisers"];
            fetchFundraisers();
        }
    }["FundraiserLiveTable.useEffect"], [
        getAllCampaigns
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FundraiserLiveTable.useEffect": ()=>{
            if (campaigns.length > 0) {
                console.log("Active fundraisers loaded:", campaigns.length);
                console.log("Sample campaign:", campaigns[0]);
            } else if (!isLoading) {
                console.log("No active fundraisers found");
            }
        }
    }["FundraiserLiveTable.useEffect"], [
        campaigns,
    ...
    // Filter for active/approved campaigns (live fundraisers)
    // According to requirements: Campaign review and approval system
    // Live campaigns are those that are approved and active
    const filteredFundraisers = campaigns.filter((item)=>{
        var _item_title, _item_shortDescription;
        const isLive = (item.status === 'active' || item.status === 'approved') && item.isActive !== false;
        const matchesSearch = ((_item_title = item.title) === null || _item_title === void 0 ? void 0 : _item_title.toLowerCase().includes(searchTerm.toLowerCase())) || ((_item_shortDescription = item.shortDescription) === null || _item_shortDescription === void 0 ? void 0 : _item_shortDescription.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    const handleEdit = (id)=>{
        ...
        window.location.href = "/admin/campaigns/".concat(id, "/edit");
    };
    const handleDelete = async (id)=>{
        ...
        try {
            const { campaignService } = await __turbopack_context__.A("[project]/src/services/campaignService.js [app-client] (ecmascript, async loader)");
            await campaignService.deleteCampaign(id);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Campaign deleted successfully");
            ...
            const errorMessage = ((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.message) || error.message || "Failed to delete campaign";
    ...
    const handleComplete = async (id)=>{
        if (!confirm("Are you sure you want to mark this campaign as completed? This will move it to Fundraised Data.")) {
            return;
        }
        try {
            const { adminService } = await __turbopack_context__.A("[project]/src/services/adminService.js [app-client] (ecmascript, async loader)");
            await adminService.completeCampaign(id);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Campaign marked as completed successfully!");
            ...
            const errorMessage = ((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.message) || error.message || "Failed to mark campaign as completed";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(errorMessage);
        }
    };
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                    ...
                    children: "FundRaiser Live Table"
                }, void 0, false, {
                    fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                    lineNumber: 110,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                    ...
                                    children: [
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                        className: "px-4 py-3 text-left text-sm font-semibold text-green-600 w-1/3",
                                                        children: "Fundraiser Summary"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                        lineNumber: 158,
                                                        columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            children: currentEntries.length > 0 ? currentEntries.map((item, index)=>{
                                                var _item_goalAmount, _item_currentAmount, _item_timeline, _item_beneficiary_contact, _item_beneficiary, _item_fundraiser, _item_beneficiary_contact1, _item_beneficiary1, _item_fundraiser1, _item_beneficiary_contact2, _item_beneficiary2, _item_fundraiser2, _item_beneficiary_contact3, _item_beneficiary3, _item_fundraiser3;
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    className: "border-b border-gray-100 hover:bg-gray-50 transition-colors ".concat(index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'),
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "px-4 py-4 text-sm text-gray-700",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "line-clamp-3",
                                                                children: item.shortDescription || item.title
                                                            }, void 0, false, {
                                                                fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                                lineNumber: 191,
                                                                columnNumber: 27
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: [
                                                                "₹",
                                                                ((_item_goalAmount = item.goalAmount) === null || _item_goalAmount === void 0 ? void 0 : _item_goalAmount.toLocaleString()) || 0
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                            lineNumber: 193,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "px-4 py-4 text-sm font-medium text-green-600",
                                                            children: [
                                                                "₹",
                                                                ((_item_currentAmount = item.currentAmount) === null || _item_currentAmount === void 0 ? void 0 : _item_currentAmount.toLocaleString()) || 0
                                                            ]
                                                        }, void 0, true, {
                                                            fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                            lineNumber: 196,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "px-4 py-4 text-sm text-gray-700",
                                                            children: ((_item_timeline = item.timeline) === null || _item_timeline === void 0 ? void 0 : _item_timeline.startDate) ? new Date(item.timeline.startDate).toLocaleDateString() : 'N/A'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                            lineNumber: 199,
                                                            columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "px-4 py-4",
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "w-24 h-24 relative rounded-lg overflow-hidden border border-gray-200",
                                                                children: item.images && item.images[0] ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "space-y-1",
                                                                children: [
                                                                    ((_item_beneficiary = item.beneficiary) === null || _item_beneficiary === void 0 ? void 0 : (_item_beneficiary_contact = _item_beneficiary.contact) === null || _item_beneficiary_contact === void 0 ? void 0 : _item_beneficiary_contact.phone) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                children: item.beneficiary.contact.phone
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                                                lineNumber: 223,
                                                                                columnNumber: 33
                                                                        ...
                                                                        lineNumber: 221,
                                                                        columnNumber: 31
                                                                    }, this) : ((_item_fundraiser = item.fundraiser) === null || _item_fundraiser === void 0 ? void 0 : _item_fundraiser.phone) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "flex items-center gap-1",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "text-gray-500",
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                children: item.fundraiser.phone
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                                                lineNumber: 228,
                                                                                columnNumber: 33
                                                                    ...
                                                                    ((_item_beneficiary1 = item.beneficiary) === null || _item_beneficiary1 === void 0 ? void 0 : (_item_beneficiary_contact1 = _item_beneficiary1.contact) === null || _item_beneficiary_contact1 === void 0 ? void 0 : _item_beneficiary_contact1.email) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "flex items-center gap-1",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "text-gray-500",
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                children: item.beneficiary.contact.email
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                                                lineNumber: 234,
                                                                                columnNumber: 33
                                                                        ...
                                                                        lineNumber: 232,
                                                                        columnNumber: 31
                                                                    }, this) : ((_item_fundraiser1 = item.fundraiser) === null || _item_fundraiser1 === void 0 ? void 0 : _item_fundraiser1.email) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        className: "flex items-center gap-1",
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                className: "text-gray-500",
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                children: item.fundraiser.email
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                                                lineNumber: 239,
                                                                                columnNumber: 33
                                                                    ...
                                                                    !((_item_beneficiary2 = item.beneficiary) === null || _item_beneficiary2 === void 0 ? void 0 : (_item_beneficiary_contact2 = _item_beneficiary2.contact) === null || _item_beneficiary_contact2 === void 0 ? void 0 : _item_beneficiary_contact2.phone) && !((_item_fundraiser2 = item.fundraiser) === null || _item_fundraiser2 === void 0 ? void 0 : _item_fundraiser2.phone) && !((_item_beneficiary3 = item.beneficiary) === null || _item_beneficiary3 === void 0 ? void 0 : (_item_beneficiary_contact3 = _item_beneficiary3.contact) === null || _item_beneficiary_contact3 === void 0 ? void 0 : _item_beneficiary_contact3.email) && !((_item_fundraiser3 = item.fundraiser) === null || _item_fundraiser3 === void 0 ? void 0 : _item_fundraiser3.email) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "px-3 py-1 rounded-full text-xs font-medium text-center ".concat(item.status === 'active' ? 'bg-green-100 text-green-800' : item.status === 'completed' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'),
                                                                    ...
                                                                    item.status === 'active' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                        onClick: ()=>handleComplete(item._id),
                                                                        className: "px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition-colors flex items-center gap-1 justify-center",
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: isLoading ? 'Loading fundraisers...' : 'No fundraisers found'
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/admin/FundraiserLiveTable.jsx",
                                                    lineNumber: 283,
                                                    columnNumber: 23
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            indexOfFirstEntry + 1,
                                            " to ",
                                            Math.min(indexOfLastEntry, filteredFundraisers.length),
                                            " of ",
...
_s(FundraiserLiveTable, "lxrZwZDEeb3L8LLqCWNe8ZncsXk=", false, function() {
    return [
...
_c = FundraiserLiveTable;
var _c;
__turbopack_context__.k.register(_c, "FundraiserLiveTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/admin/fundraiser-live/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$FundraiserLiveTable$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/FundraiserLiveTable.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function FundraiserLivePage() {
    ...
    if (isLoading || !canRender) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/app/admin/fundraiser-live/page.jsx",
                lineNumber: 12,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$AdminLayout$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$FundraiserLiveTable$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/src/app/admin/fundraiser-live/page.jsx",
            lineNumber: 19,
            columnNumber: 7
        }, this)
...
_s(FundraiserLivePage, "ZWEOMdC4TlaB5ff5KIb3Crtt+xg=", false, function() {
    return [
...
_c = FundraiserLivePage;
var _c;
__turbopack_context__.k.register(_c, "FundraiserLivePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_5d5df589._.js.map
...
"[project]/src/components/admin/WebsiteQueriesTable.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WebsiteQueriesTable() {
    ...
    const fetchQueries = async ()=>{
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$adminService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminService"].getAllContactQueries({
                page: 1,
                limit: 100 // Fetch more to show all queries
            });
            console.log("Contact queries response:", response);
            // Backend returns: { success: true, data: [...], pagination: {...} }
            const queriesData = (response === null || response === void 0 ? void 0 : response.data) || (response === null || response === void 0 ? void 0 : response.queries) || [];
            console.log("Contact queries loaded:", queriesData.length);
            console.log("Sample query:", queriesData[0]);
    ...
    const handleMarkAsResolved = async (queryId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$adminService$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["adminService"].updateQueryStatus(queryId, {
                status: 'resolved'
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Query marked as resolved');
            fetchQueries(); // Refresh the list
        } catch (error) {
            console.error('Failed to update query:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to update query status');
        }
    };
    // Filter queries based on search term
    const filteredQueries = queries.filter((query)=>{
        var _query_name, _query_email, _query_phone, _query_subject, _query_message;
        return ((_query_name = query.name) === null || _query_name === void 0 ? void 0 : _query_name.toLowerCase().includes(searchTerm.toLowerCase())) || ((_query_email = query.email) === null || _query_email === void 0 ? void 0 : _query_email.toLowerCase().includes(searchTerm.toLowerCase())) || ((_query_phone = query.phone) === null || _query_phone === void 0 ? void 0 : _query_phone.includes(searchTerm)) || ((_query_subject = query.subject) === null || _query_subject === void 0 ? void 0 : _query_subject.toLowerCase().includes(searchTerm.toLowerCase())) || ((_query_message = query.message) === null || _query_message === void 0 ? void 0 : _query_message.toLowerCase().includes(searchTerm.toLowerCase()));
    });
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: "Contact Queries"
                    }, void 0, false, {
                        fileName: "[project]/src/components/admin/WebsiteQueriesTable.jsx",
                        lineNumber: 67,
                        columnNumber: 9
                    }, this),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: "Website Contact Queries Table"
                    }, void 0, false, {
                        fileName: "[project]/src/components/admin/WebsiteQueriesTable.jsx",
                        lineNumber: 80,
                        columnNumber: 9
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        lineNumber: 127,
                                        columnNumber: 17
                                    }, this) : filteredQueries.length > 0 ? filteredQueries.slice((currentPage - 1) * entriesPerPage, currentPage * entriesPerPage).map((query, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            className: "border-b hover:bg-gray-50 transition-colors ".concat(idx % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'),
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-4 py-3",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "px-3 py-1 rounded-full text-xs font-medium ".concat(query.status === 'resolved' ? 'bg-green-100 text-green-700' : query.status === 'in-progress' ? 'bg-blue-100 text-blue-700' : 'bg-yellow-100 text-yellow-700'),
                                                        children: query.status ? query.status.replace('-', ' ').toUpperCase() : 'PENDING'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/admin/WebsiteQueriesTable.jsx",
                                                        lineNumber: 155,
                                                        columnNumber: 23
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: "px-4 py-2 bg-green-700 text-white text-sm rounded-lg hover:bg-green-800 transition disabled:opacity-50 disabled:cursor-not-allowed",
                                                        disabled: query.status === 'resolved',
                                                        children: query.status === 'resolved' ? 'Resolved' : 'Mark As Fixed'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/admin/WebsiteQueriesTable.jsx",
                                                        lineNumber: 164,
                                                        columnNumber: 23
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: [
                                                ...
                                                isLoading ? 'Loading queries...' : searchTerm ? 'No queries match your search' : 'No contact queries found'
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/components/admin/WebsiteQueriesTable.jsx",
                                            lineNumber: 176,
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    " to ",
                                    Math.min(currentPage * entriesPerPage, filteredQueries.length),
                                    " of ",
...
_s(WebsiteQueriesTable, "zbtQhOrwIGmUHnpuD0dQ1hLgO38=");
_c = WebsiteQueriesTable;
var _c;
__turbopack_context__.k.register(_c, "WebsiteQueriesTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/admin/queries/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$WebsiteQueriesTable$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/admin/WebsiteQueriesTable.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function WebsiteQueriesPage() {
    ...
    if (isLoading || !canRender) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/app/admin/queries/page.jsx",
                lineNumber: 12,
                columnNumber: 9
            }, this)
        }, void 0, false, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$AdminLayout$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$admin$2f$WebsiteQueriesTable$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
            fileName: "[project]/src/app/admin/queries/page.jsx",
            lineNumber: 19,
            columnNumber: 7
        }, this)
...
_s(WebsiteQueriesPage, "ZWEOMdC4TlaB5ff5KIb3Crtt+xg=", false, function() {
    return [
...
_c = WebsiteQueriesPage;
var _c;
__turbopack_context__.k.register(_c, "WebsiteQueriesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_83d1f0a2._.js.map
...
function OurVolunteersTable() {
    ...
    const handleEdit = (userId)=>{
        ...
        window.location.href = "/admin/users/".concat(userId, "/edit");
    };
    const handleDelete = async (userId)=>{
        ...
        try {
            ...
            const errorMessage = ((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.message) || error.message || "Failed to remove volunteer";
...
_s(OurVolunteersPage, "ZWEOMdC4TlaB5ff5KIb3Crtt+xg=", false, function() {
    return [
...
//# sourceMappingURL=src_acc3eccf._.js.map
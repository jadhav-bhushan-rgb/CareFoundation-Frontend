...
function FundraiserRequestTable() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchRequests = async ()=>{
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Failed to load requests");
            }
        };
        fetchRequests();
    }, [
    ...
    const handleApprove = async (campaignId)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Failed to approve fundraiser");
        }
    };
    const handleReject = async (campaignId)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Failed to reject fundraiser");
        }
    };
    const filteredRequests = campaigns.filter((campaign)=>campaign.title?.toLowerCase().includes(searchTerm.toLowerCase()) || campaign.fundraiser?.name?.toLowerCase().includes(searchTerm.toLowerCase()) || campaign.fundraiser?.email?.toLowerCase().includes(searchTerm.toLowerCase()) || campaign.beneficiary?.name?.toLowerCase().includes(searchTerm.toLowerCase()));
                                            ...
                                            children: currentEntries.length > 0 ? currentEntries.map((campaign, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: campaign.fundraiser?.phone || campaign.beneficiary?.contact || 'N/A'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/admin/FundraiserRequestTable.jsx",
                                                            lineNumber: 150,
                                                            columnNumber: 25
...
//# sourceMappingURL=src_9f5bb43f._.js.map
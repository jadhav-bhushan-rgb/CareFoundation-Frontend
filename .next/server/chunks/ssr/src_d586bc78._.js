...
function PartnerRequestTable() {
    ...
    const handleApprove = async (partnerId)=>{
        try {
            ...
            const errorMessage = error.response?.data?.message || error.message || "Failed to approve partner";
    ...
    const handleReject = async (partnerId)=>{
        ...
        try {
            ...
            const errorMessage = error.response?.data?.message || error.message || "Failed to reject partner";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(errorMessage);
        }
    };
...
//# sourceMappingURL=src_d586bc78._.js.map
...
function UploadFundraiserForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const backendBaseURL = ("TURBOPACK compile-time value", "http://localhost:5000/api")?.replace('/api', '') || 'http://localhost:5000';
            ...
            if (error.response?.data?.errors && Array.isArray(error.response.data.errors)) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Failed to create campaign. Please check all fields and try again.', {
                    duration: 5000
                });
            }
        } finally{
...
//# sourceMappingURL=src_3b8116ef._.js.map
...
function VolunteerRequestTable() {
    ...
    const handleActivate = async (userId)=>{
        try {
            console.log("Activating volunteer:", userId);
            ...
            const errorMessage = error.response?.data?.message || error.message || "Failed to activate volunteer";
    ...
    const handleBlock = async (userId)=>{
        ...
        try {
            console.log("Blocking volunteer:", userId);
            await updateUserStatus(userId, {
                isActive: false
            });
            ...
            const errorMessage = error.response?.data?.message || error.message || "Failed to block volunteer";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(errorMessage);
        }
    };
...
//# sourceMappingURL=src_9ab935a0._.js.map
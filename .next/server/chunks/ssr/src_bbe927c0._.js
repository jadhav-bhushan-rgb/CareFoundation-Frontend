...
function UserDashboard() {
    ...
    const { getUserCampaigns, userCampaigns } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$campaignStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
        ...
        const fetchDashboardData = async ()=>{
            ...
            try {
                ...
                const [donationsResponse, campaignsResponse, couponsResponse] = await Promise.allSettled([
                    getUserDonations(),
                    getUserCampaigns(),
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$couponService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["couponService"].getUserCoupons().catch(()=>({
                            data: []
                        }))
                ]);
                ...
                const currentDonations = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$donationStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getState().userDonations || [];
                const currentCampaigns = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$campaignStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getState().userCampaigns || [];
                // Calculate total donations
                let totalDonation = 0;
                if (donationsResponse.status === 'fulfilled') {
                    totalDonation = currentDonations.reduce((sum, donation)=>sum + (donation.amount || 0), 0);
                }
                ...
                if (campaignsResponse.status === 'fulfilled') {
                    ...
                    totalRaised = currentCampaigns.reduce((sum, campaign)=>sum + (campaign.amountRaised || 0), 0);
                    activeCampaigns = currentCampaigns.filter((c)=>c.status === 'active' || c.status === 'approved').length;
                }
                // Get coupons count
                let totalCoupons = 0;
                if (couponsResponse.status === 'fulfilled' && couponsResponse.value?.data) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (userCampaigns && userCampaigns.length > 0) {
            const totalRaised = userCampaigns.reduce((sum, campaign)=>sum + (campaign.amountRaised || 0), 0);
            const activeCampaigns = userCampaigns.filter((c)=>c.status === 'active' || c.status === 'approved').length;
            setDashboardData((prev)=>({
                    ...prev,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            (dashboardData.totalCampaigns > 0 || dashboardData.totalRaised > 0 || dashboardData.totalCoupons > 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-1 md:grid-cols-3 gap-6",
                children: [
                    dashboardData.totalCampaigns > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            dashboardData.activeCampaigns > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    dashboardData.totalRaised > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-white rounded-lg shadow-md border border-gray-200 p-6",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 text-sm font-medium mb-2",
                    ...
                    dashboardData.totalCoupons > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "bg-white rounded-lg shadow-md border border-gray-200 p-6",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 text-sm font-medium mb-2",
...
//# sourceMappingURL=src_bbe927c0._.js.map
...
function Banner() {
    ...
    const handleSubmitDonation = (e)=>{
        ...
        if (!donorInfo.firstName || !donorInfo.email || !donorInfo.amount) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Please enter your name, email, and donation amount");
            return;
        }
        // Validate amount
        const amount = parseFloat(donorInfo.amount);
        if (isNaN(amount) || amount < 10) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Minimum donation amount is ₹10");
            return;
        }
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    2000
                                                                        ...
                                                                        className: `px-3 py-1.5 rounded-lg text-sm font-medium transition ${donorInfo.amount === amt.toString() ? 'bg-green-500 text-white' : 'bg-white/80 text-gray-700 hover:bg-white'}`,
                                                                        children: [
                                                                            "₹",
                                                                            amt
                                                                        ]
...
function TrustIndicators() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchStats = async ()=>{
            try {
                const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000/api")}/campaigns/stats`);
                if (response.ok) {
                    const data = await response.json();
                    setStats({
                        totalRaised: data.data?.totalRaised || 25000000,
                        activeCampaigns: data.data?.activeCampaigns || 150,
                        totalDonors: data.data?.totalDonors || 5000,
                        livesImpacted: data.data?.livesImpacted || 10000
                    });
                } else {
                    // Use fallback stats
                    setStats({
...
//# sourceMappingURL=src_2eaf830d._.js.map
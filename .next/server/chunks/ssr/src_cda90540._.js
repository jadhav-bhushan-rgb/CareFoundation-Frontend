...
function WebsiteQueriesTable() {
    ...
    const fetchQueries = async ()=>{
        ...
        try {
            ...
            const queriesData = response?.data || response?.queries || [];
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(error.response?.data?.message || 'Failed to load contact queries');
            setQueries([]);
        } finally{
            setIsLoading(false);
        }
    ...
    const filteredQueries = queries.filter((query)=>query.name?.toLowerCase().includes(searchTerm.toLowerCase()) || query.email?.toLowerCase().includes(searchTerm.toLowerCase()) || query.phone?.includes(searchTerm) || query.subject?.toLowerCase().includes(searchTerm.toLowerCase()) || query.message?.toLowerCase().includes(searchTerm.toLowerCase()));
...
//# sourceMappingURL=src_cda90540._.js.map